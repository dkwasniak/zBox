...
## Legenda
- `[x]` = uruchomiono i przeszło na hardware
- `[ ]` = kod gotowy, czeka na uruchomienie

## Wyniki

### Etap 1 — native (bez hardware)
```
...
### Etapy 2+3 — DUT przez /dev/cu.usbserial-10
```
...
test_diag_all_tasks_above_512  PASS  (sprawdź wartości w logach)
...
# Etapy 5+6 (wymaga tester ESP32-S3)
